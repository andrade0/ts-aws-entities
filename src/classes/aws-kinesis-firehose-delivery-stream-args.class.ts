...
import { AwsKinesisFirehoseDeliveryStreamArgsName,  AwsKinesisFirehoseDeliveryStreamArgsKinesisSourceConfiguration,  AwsKinesisFirehoseDeliveryStreamArgsS3Configuration,  AwsKinesisFirehoseDeliveryStreamArgsRedshiftConfiguration,  AwsKinesisFirehoseDeliveryStreamArgsCloudwatchLoggingOptions,  AwsKinesisFirehoseDeliveryStreamArgsProcessingConfiguration,  AwsKinesisFirehoseDeliveryStreamArgsParameters,  AwsKinesisFirehoseDeliveryStreamArgsDeserializer,  AwsKinesisFirehoseDeliveryStreamArgsSerializer } from '.';
