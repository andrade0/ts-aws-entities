...
import { AwsDynamodbTableArgsAttribute,  AwsDynamodbTableArgsTtl,  AwsDynamodbTableArgsLocalSecondaryIndex,  AwsDynamodbTableArgsGlobalSecondaryIndex,  AwsDynamodbTableArgsServerSideEncryption,  AwsDynamodbTableArgsPointInTimeRecovery } from '.';
