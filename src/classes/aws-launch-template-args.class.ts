...
import { AwsLaunchTemplateArgsBlockDeviceMappings,  AwsLaunchTemplateArgsCapacityReservationSpecification,  AwsLaunchTemplateArgsCreditSpecification,  AwsLaunchTemplateArgsElasticGpuSpecifications,  AwsLaunchTemplateArgsIamInstanceProfile,  AwsLaunchTemplateArgsInstanceMarketOptions,  AwsLaunchTemplateArgsLicenseSpecification,  AwsLaunchTemplateArgsMonitoring,  AwsLaunchTemplateArgsNetworkInterfaces,  AwsLaunchTemplateArgsPlacement,  AwsLaunchTemplateArgsTagSpecifications } from '.';
