import { AwsOpsworksRailsAppLayerArgsIntterface } from '../interfaces';
import { AwsOpsworksRailsAppLayerArgsEbsVolume, AwsOpsworksRailsAppLayerArgsName } from '.';

export class AwsOpsworksRailsAppLayerArgs implements AwsOpsworksRailsAppLayerArgsIntterface {
  stack_id: string;
  name?: AwsOpsworksRailsAppLayerArgsName;
  app_server?: string;
