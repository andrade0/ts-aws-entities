...
import {
  AwsS3BucketInventoryArgsBucket,
  AwsS3BucketInventoryArgsDestination,
  AwsS3BucketInventoryArgsFilter,
  AwsS3BucketInventoryArgsSchedule,
  AwsS3BucketInventoryArgsSseKms,
} from '.';
