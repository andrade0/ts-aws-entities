...
import {
  AwsAcmpcaCertificateAuthorityArgsCertificateAuthorityConfiguration,
  AwsAcmpcaCertificateAuthorityArgsId,
  AwsAcmpcaCertificateAuthorityArgsRevocationConfiguration,
} from '.';
