...
import {
  AwsCodebuildProjectArgsArtifacts,
  AwsCodebuildProjectArgsCache,
  AwsCodebuildProjectArgsEnvironment,
  AwsCodebuildProjectArgsSource,
  AwsCodebuildProjectArgsVpcConfig,
} from '.';
