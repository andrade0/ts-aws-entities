import { AwsIamAccountPasswordPolicyArgsIntterface } from '../interfaces';


export class AwsIamAccountPasswordPolicyArgs implements AwsIamAccountPasswordPolicyArgsIntterface {
