import { AwsCloudtrailArgsIntterface } from '../interfaces';
import { AwsCloudtrailArgsEventSelector } from '.';

export class AwsCloudtrailArgs implements AwsCloudtrailArgsIntterface {
  	name: string;
