import { AwsSnsPlatformApplicationArgsIntterface } from '../interfaces';


export class AwsSnsPlatformApplicationArgs implements AwsSnsPlatformApplicationArgsIntterface {
  	name: string;
	platform: string;
