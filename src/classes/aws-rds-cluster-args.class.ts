import { AwsRdsClusterArgsIntterface } from '../interfaces';
import { AwsRdsClusterArgsEngine, AwsRdsClusterArgsPort } from '.';

export class AwsRdsClusterArgs implements AwsRdsClusterArgsIntterface {
  ...
  engine?: AwsRdsClusterArgsEngine;
  engine_mode?: string;
