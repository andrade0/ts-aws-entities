...
import {
  AwsCodedeployDeploymentGroupArgsAlarmConfiguration,
  AwsCodedeployDeploymentGroupArgsAutoRollbackConfiguration,
  AwsCodedeployDeploymentGroupArgsBlueGreenDeploymentConfig,
  AwsCodedeployDeploymentGroupArgsDeploymentStyle,
  AwsCodedeployDeploymentGroupArgsEc2TagFilter,
  AwsCodedeployDeploymentGroupArgsLoadBalancerInfo,
  AwsCodedeployDeploymentGroupArgsProdTrafficRoute,
  AwsCodedeployDeploymentGroupArgsTargetGroup,
  AwsCodedeployDeploymentGroupArgsTestTrafficRoute,
