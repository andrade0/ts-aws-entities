import { AwsCognitoUserPoolArgsLambdaConfigIntterface } from '../interfaces';


export class AwsCognitoUserPoolArgsLambdaConfig implements AwsCognitoUserPoolArgsLambdaConfigIntterface {
