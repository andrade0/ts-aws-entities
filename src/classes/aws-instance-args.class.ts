...
import { AwsInstanceArgsCpuCoreCount,  AwsInstanceArgsRootBlockDevice,  AwsInstanceArgsEbsBlockDevice,  AwsInstanceArgsEphemeralBlockDevice,  AwsInstanceArgsNetworkInterface,  AwsInstanceArgsCreditSpecification } from '.';
