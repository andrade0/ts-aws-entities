...
import {
  AwsCognitoUserPoolArgsAdminCreateUserConfig,
  AwsCognitoUserPoolArgsDeviceConfiguration,
  AwsCognitoUserPoolArgsEmailConfiguration,
  AwsCognitoUserPoolArgsLambdaConfig,
  AwsCognitoUserPoolArgsPasswordPolicy,
  AwsCognitoUserPoolArgsSchema,
  AwsCognitoUserPoolArgsSmsConfiguration,
  AwsCognitoUserPoolArgsUserPoolAddOns,
  AwsCognitoUserPoolArgsVerificationMessageTemplate,
} from '.';
