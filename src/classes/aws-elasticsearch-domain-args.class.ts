...
import {
  AwsElasticsearchDomainArgsClusterConfig,
  AwsElasticsearchDomainArgsEbsOptions,
  AwsElasticsearchDomainArgsEncryptAtRest,
  AwsElasticsearchDomainArgsLogPublishingOptions,
  AwsElasticsearchDomainArgsNodeToNodeEncryption,
  AwsElasticsearchDomainArgsSnapshotOptions,
  AwsElasticsearchDomainArgsVpcOptions,
} from '.';
