...
import {
  AwsCloudwatchEventTargetArgsBatchTarget,
  AwsCloudwatchEventTargetArgsEcsTarget,
  AwsCloudwatchEventTargetArgsInput,
  AwsCloudwatchEventTargetArgsKinesisTarget,
  AwsCloudwatchEventTargetArgsRunCommandTargets,
  AwsCloudwatchEventTargetArgsSqsTarget,
} from '.';
