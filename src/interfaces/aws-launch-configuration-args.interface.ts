import {
  AwsLaunchConfigurationArgsEbsBlockDeviceIntterface,
  AwsLaunchConfigurationArgsEphemeralBlockDeviceIntterface,
  AwsLaunchConfigurationArgsRootBlockDeviceIntterface,
} from '.';
