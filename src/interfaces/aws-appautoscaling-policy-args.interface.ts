import { AwsAppautoscalingPolicyArgsStepScalingPolicyConfigurationIntterface, AwsAppautoscalingPolicyArgsTargetTrackingScalingPolicyConfigurationIntterface } from '.';
