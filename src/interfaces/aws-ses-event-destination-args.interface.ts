import {
  AwsSesEventDestinationArgsCloudwatchDestinationIntterface,
  AwsSesEventDestinationArgsKinesisDestinationIntterface,
  AwsSesEventDestinationArgsSnsDestinationIntterface,
} from '.';
