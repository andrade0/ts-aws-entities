import { AwsOpsworksInstanceArgsRootBlockDeviceIntterface, AwsOpsworksInstanceArgsEbsBlockDeviceIntterface, AwsOpsworksInstanceArgsEphemeralBlockDeviceIntterface } from '.';
