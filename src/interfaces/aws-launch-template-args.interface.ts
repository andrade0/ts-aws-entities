import {
  AwsLaunchTemplateArgsBlockDeviceMappingsIntterface,
  AwsLaunchTemplateArgsCapacityReservationSpecificationIntterface,
  AwsLaunchTemplateArgsCreditSpecificationIntterface,
  AwsLaunchTemplateArgsElasticGpuSpecificationsIntterface,
  AwsLaunchTemplateArgsIamInstanceProfileIntterface,
  AwsLaunchTemplateArgsInstanceMarketOptionsIntterface,
  AwsLaunchTemplateArgsLicenseSpecificationIntterface,
  AwsLaunchTemplateArgsMonitoringIntterface,
  AwsLaunchTemplateArgsNetworkInterfacesIntterface,
  AwsLaunchTemplateArgsPlacementIntterface,
