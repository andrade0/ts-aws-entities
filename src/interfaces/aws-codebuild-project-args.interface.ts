import { AwsCodebuildProjectArgsArtifactsIntterface, AwsCodebuildProjectArgsEnvironmentIntterface, AwsCodebuildProjectArgsSourceIntterface, AwsCodebuildProjectArgsCacheIntterface, AwsCodebuildProjectArgsVpcConfigIntterface } from '.';
