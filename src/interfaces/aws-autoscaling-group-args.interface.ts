import { AwsAutoscalingGroupArgsLaunchTemplateIntterface, AwsAutoscalingGroupArgsMixedInstancesPolicyIntterface, AwsAutoscalingGroupArgsTagIntterface } from '.';

export interface AwsAutoscalingGroupArgsIntterface {
  	name?: string;
	name_prefix?: string;
	max_size: string;
	min_size: string;
	...
	launch_template?: AwsAutoscalingGroupArgsLaunchTemplateIntterface;
	mixed_instances_policy?: AwsAutoscalingGroupArgsMixedInstancesPolicyIntterface;
	...
	tag?: AwsAutoscalingGroupArgsTagIntterface;
	tags?: string;
