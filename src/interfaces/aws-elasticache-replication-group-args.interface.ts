import { AwsElasticacheReplicationGroupArgsPortIntterface } from '.';

export interface AwsElasticacheReplicationGroupArgsIntterface {
  ...
  port?: AwsElasticacheReplicationGroupArgsPortIntterface;
