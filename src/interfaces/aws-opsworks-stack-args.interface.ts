import { AwsOpsworksStackArgsCustomCookbooksSourceIntterface } from '.';

export interface AwsOpsworksStackArgsIntterface {
  name: string;
  region: string;
  ...
  custom_cookbooks_source?: AwsOpsworksStackArgsCustomCookbooksSourceIntterface;
  custom_json?: string;
  default_os?: string;
