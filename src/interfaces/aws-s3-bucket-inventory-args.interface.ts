import { AwsS3BucketInventoryArgsBucketIntterface, AwsS3BucketInventoryArgsScheduleIntterface, AwsS3BucketInventoryArgsDestinationIntterface, AwsS3BucketInventoryArgsFilterIntterface, AwsS3BucketInventoryArgsSseKmsIntterface } from '.';
