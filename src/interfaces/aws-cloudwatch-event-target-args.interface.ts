import {
  AwsCloudwatchEventTargetArgsBatchTargetIntterface,
  AwsCloudwatchEventTargetArgsEcsTargetIntterface,
  AwsCloudwatchEventTargetArgsInputIntterface,
  AwsCloudwatchEventTargetArgsKinesisTargetIntterface,
  AwsCloudwatchEventTargetArgsRunCommandTargetsIntterface,
  AwsCloudwatchEventTargetArgsSqsTargetIntterface,
} from '.';
