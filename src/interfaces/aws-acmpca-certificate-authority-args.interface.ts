import {
  AwsAcmpcaCertificateAuthorityArgsCertificateAuthorityConfigurationIntterface,
  AwsAcmpcaCertificateAuthorityArgsIdIntterface,
  AwsAcmpcaCertificateAuthorityArgsRevocationConfigurationIntterface,
} from '.';
