import { AwsWafregionalWebAclArgsDefaultActionIntterface, AwsWafregionalWebAclArgsLoggingConfigurationIntterface, AwsWafregionalWebAclArgsActionIntterface } from '.';
