import {
  AwsGlueCrawlerArgsDynamodbTargetIntterface,
  AwsGlueCrawlerArgsJdbcTargetIntterface,
  AwsGlueCrawlerArgsS3TargetIntterface,
  AwsGlueCrawlerArgsSchemaChangePolicyIntterface,
} from '.';
